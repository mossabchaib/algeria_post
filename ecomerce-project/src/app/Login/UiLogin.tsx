  ...
  <path fill="none" d="M0 0h24v24H0z"/>
    ...
    <form className={style.form}>
      <div className={style.formGroup}>
        ...
        <input required placeholder="Enter your First name" name="email" id="email" type="text" />
      </div>
      <div className={style.formGroup}>
        <label htmlFor="email">Last Name</label>
        <input required placeholder="Enter your Last Name" name="email" id="email" type="text" />
      </div>
      <div className={style.formGroup}>
