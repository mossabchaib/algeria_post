...
const Navbar = (data:any) => {
  ...
  const pathn:any='/Admin_page'||'/Admin_page/add_product'||'/Admin_page/User-acount'||'/Admin_page/detelse_comonde'||'/Admin_page/Chart_comonde'
...
const toggleSidebar = () => {
 ...
 <div className={styles.nav}>
     ...
     style={{}} onClick={toggleSidebar} > Category
