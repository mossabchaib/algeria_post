...
console.log("All fields are necessary.");
    ...
    console.log(email=='mossab.chb230@gmail.com')
    console.log(email)
  if(email=='mossab.chb230@gmail.com'&& password=='mossab2004')
   {
    alert('welcom Admin')
...
<Link href="/Signe"><button onClick={handleSubmit} className={style.formSubmitBtn}>
        Sign In
      </button></Link>
